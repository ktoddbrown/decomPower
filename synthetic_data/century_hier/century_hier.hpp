...
namespace century_hier_model_namespace {
    ...
    try {
        {
            ...
            stan::math::assign(C_t, integrate_ode_bdf(century_model_functor__(), C_t0, t0, to_array_1d(ts), theta, x_r, x_i, pstream__));
...
class century_hier_model : public prob_grad {
private:
    double totalC_t0;
    double t0;
    int N_t;
    ...
    vector<int> x_i;
public:
    century_hier_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "century_hier_model_namespace::century_hier_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "century_hier_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
...
typedef century_hier_model_namespace::century_hier_model stan_model;
