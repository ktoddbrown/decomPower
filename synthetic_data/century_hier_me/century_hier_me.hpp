...
namespace century_hier_me_model_namespace {
...
template <typename T1__, typename T2__, typename T3__, typename T4__, typename T5__, typename T6__, typename T7__, typename T8__, typename T9__, typename T10__>
Eigen::Matrix<typename boost::math::tools::promote_args<T1__, T2__, T3__, T4__, typename boost::math::tools::promote_args<T5__, T6__, T7__, T8__, typename boost::math::tools::promote_args<T9__, T10__>::type>::type>::type, Eigen::Dynamic,1>
evolved_CO2(const int& N_t,
                ...
                const T8__& a12,
                const T9__& a32,
                const T10__& a13, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T1__, T2__, T3__, T4__, typename boost::math::tools::promote_args<T5__, T6__, T7__, T8__, typename boost::math::tools::promote_args<T9__, T10__>::type>::type>::type fun_scalar_t__;
    ...
    try {
        {
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  C_t0(static_cast<Eigen::VectorXd::Index>(3));
            (void) C_t0;  // dummy to suppress unused var warning
            stan::math::initialize(C_t0, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(C_t0,DUMMY_VAR__);
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  A(static_cast<Eigen::VectorXd::Index>(3),static_cast<Eigen::VectorXd::Index>(3));
            (void) A;  // dummy to suppress unused var warning
            stan::math::initialize(A, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(A,DUMMY_VAR__);
            vector<Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1> > C_t(N_t, (Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1> (static_cast<Eigen::VectorXd::Index>(3))));
            ...
            stan::math::assign(get_base1_lhs(A,1,1,"A",1), -(get_base1(k,1,"k",1)));
            current_statement_begin__ = 31;
            stan::math::assign(get_base1_lhs(A,1,2,"A",1), (a12 * get_base1(k,2,"k",1)));
            current_statement_begin__ = 32;
            stan::math::assign(get_base1_lhs(A,1,3,"A",1), (a13 * get_base1(k,3,"k",1)));
            current_statement_begin__ = 33;
            stan::math::assign(get_base1_lhs(A,2,1,"A",1), (a21 * get_base1(k,1,"k",1)));
            current_statement_begin__ = 34;
            stan::math::assign(get_base1_lhs(A,2,2,"A",1), -(get_base1(k,2,"k",1)));
            current_statement_begin__ = 35;
            stan::math::assign(get_base1_lhs(A,2,3,"A",1), 0);
            current_statement_begin__ = 36;
            stan::math::assign(get_base1_lhs(A,3,1,"A",1), (a31 * get_base1(k,1,"k",1)));
            current_statement_begin__ = 37;
            stan::math::assign(get_base1_lhs(A,3,2,"A",1), (a32 * get_base1(k,2,"k",1)));
            current_statement_begin__ = 38;
            stan::math::assign(get_base1_lhs(A,3,3,"A",1), -(get_base1(k,3,"k",1)));
            current_statement_begin__ = 40;
            stan::math::assign(C_t0, multiply(gamma,totalC_t0));
            current_statement_begin__ = 42;
            for (int t = 1; t <= N_t; ++t) {

                current_statement_begin__ = 43;
                stan::math::assign(get_base1_lhs(C_t,t,"C_t",1), multiply(matrix_exp(multiply((get_base1(ts,t,"ts",1) - t0),A)),C_t0));
...
struct evolved_CO2_functor__ {
    ...
    operator()(const int& N_t,
                ...
                const T8__& a12,
                const T9__& a32,
                const T10__& a13, std::ostream* pstream__) const {
        return evolved_CO2(N_t, t0, ts, gamma, totalC_t0, k, a21, a31, a12, a32, a13, pstream__);
    }
};

class century_hier_me_model : public prob_grad {
private:
    double totalC_t0;
    double t0;
    int N_t;
    ...
    matrix_d CO2_flux;
public:
    century_hier_me_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "century_hier_me_model_namespace::century_hier_me_model";
        ...
        try {
            ...
            for (int i = 1; i <= num_rep; ++i) {
                ...
                stan::model::assign(CO2_meas, 
                            ...
                            evolved_CO2(N_t,t0,t_meas,gamma,totalC_t0,k,get_base1(a21,i,"a21",1),get_base1(a31,i,"a31",1),get_base1(a12,i,"a12",1),get_base1(a32,i,"a32",1),get_base1(a13,i,"a13",1), pstream__), 
                            "assigning variable CO2_meas");
                current_statement_begin__ = 96;
                stan::model::assign(CO2_cap, 
                            stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list())), 
                            evolved_CO2(N_t,t0,t_cap,gamma,totalC_t0,k,get_base1(a21,i,"a21",1),get_base1(a31,i,"a31",1),get_base1(a12,i,"a12",1),get_base1(a32,i,"a32",1),get_base1(a13,i,"a13",1), pstream__), 
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("CO2_flux_hat_pred");
    }
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "century_hier_me_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
        ...
        matrix_d CO2_flux_hat_pred(static_cast<Eigen::VectorXd::Index>(N_t),static_cast<Eigen::VectorXd::Index>(num_rep));
        (void) CO2_flux_hat_pred;  // dummy to suppress unused var warning
        stan::math::initialize(CO2_flux_hat_pred, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(CO2_flux_hat_pred,DUMMY_VAR__);
        stan::math::assign(CO2_flux_hat_pred,CO2_flux_hat);
        ...
        for (int k_1__ = 0; k_1__ < num_rep; ++k_1__) {
            for (int k_0__ = 0; k_0__ < N_t; ++k_0__) {
                vars__.push_back(CO2_flux_hat_pred(k_0__, k_1__));
            }
        }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_1__ = 1; k_1__ <= num_rep; ++k_1__) {
            for (int k_0__ = 1; k_0__ <= N_t; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "CO2_flux_hat_pred" << '.' << k_0__ << '.' << k_1__;
                param_names__.push_back(param_name_stream__.str());
            }
        }
    }
...
typedef century_hier_me_model_namespace::century_hier_me_model stan_model;
